...
export const getWeights = async () => {
    try {
        ...
        const response = await fetch(API_URL.concat('weights/get_weights/'), {
            method: 'GET',
            headers: headers,
        });
...
export const deleteWeight = async (id: number) => {
    try {
        ...
        const response = await fetch(API_URL.concat('weights/delete_weight/'), {
            method: 'DELETE',
            headers: headers,
            body: JSON.stringify({ weight_id: id }),
        });
